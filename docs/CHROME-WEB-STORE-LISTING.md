...
para Precio Real v0.2.1. Idioma principal: español (Argentina).

> Última revisión: 2026-05-09 (v11 — sincronizado con manifest v0.2.1 de 96 retailers, ciclo 1629).
...
- Browse Mercado Libre, Frávega, Garbarino, Falabella, Carrefour, Amazon Argentina, or any of the 96 supported sites.
...
Dominios solicitados (96 retailers de e-commerce argentino):
